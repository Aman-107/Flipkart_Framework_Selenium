...
public class Optimised_Code extends BaseTest {
	...
	// Explicit constructor that throws IOException
    public Optimised_Code() throws IOException {
        driver = LoadCookies(); // Call the method that throws IOException
	...
	public void Login() throws IOException {
		String account = homePage.accountName();
		System.out.println("Login Successfully with account : " + account);
	}
	@Test
...
//name, phone, pincode, locality, descrption, city, state		
	...
	public void coupons() throws InterruptedException { //for coupons done the implementation for flight bookings
